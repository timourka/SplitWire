...
func OpenSocket(string, int16) (*Handle, error) { return nil, errors.New("WinDivert is Windows-only") }
func (*Handle) Close() error                    { return nil }
func (*Handle) SetParam(uint64, uint64) error   { return nil }
func (*Handle) TuneQueue() error                { return nil }
...
func (*Handle) RecvSocket() (SocketEvent, error)  { return SocketEvent{}, errors.New("Windows-only") }
